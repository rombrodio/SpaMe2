...
- **Supabase** — project `avnsuyiyhcnihsnisgig`. Migrations in `supabase/migrations/` are the source of truth; `00001_*` through `00021_*` are applied.
...
- **Phase 6 — Receptionist role + portal** (gating for Phases 7 + 8)
