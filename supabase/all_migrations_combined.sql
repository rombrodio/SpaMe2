-- ==========================================================
-- READ-ONLY REFERENCE — concatenated view of every migration
-- in supabase/migrations/. Regenerated by the snippet below
-- after any migration change.
--
-- DO NOT paste this file into an existing Supabase project —
-- it expects an empty database and will error on the first
-- CREATE TYPE against a type that already exists. For an
-- existing project, paste the individual new migration(s) into
-- the Supabase SQL editor in numerical order.
--
-- Regenerate (from repo root):
--   cd supabase && (echo ""; for f in migrations/*.sql; do
--     echo ""; echo "-- ============================================================"
--     echo "-- $(basename $f)"; echo "-- ============================================================"
--     cat "$f"; done) > all_migrations_combined.sql
-- ==========================================================
...
-- ============================================================
-- 00013_fix_advisor_warnings.sql
-- ============================================================
-- ==========================================================
...
-- ============================================================
-- 00014_regenerate_seed_uuids.sql
-- ============================================================
-- ==========================================================
...
-- ============================================================
-- 00016_payment_status_authorized_index.sql
-- ============================================================
-- ==========================================================
